...
/// A class that contains all theme configurations for the mobile blog application.
/// Implements Contemporary Content-First Minimalism with Adaptive Reading Palette.
class AppTheme {
  AppTheme._();

  // Adaptive Reading Palette - Optimized for extended mobile reading sessions
  // Light theme colors
  ...
  static const Color backgroundLight =
      Color(0xFFFFFFFF); // Pure white for reading surfaces
  static const Color surfaceLight =
      Color(0xFFF8FAFC); // Subtle off-white for cards
  static const Color accentLight =
      Color(0xFF10B981); // Fresh green for success states
  static const Color warningLight =
      Color(0xFFF59E0B); // Amber for attention elements
  static const Color errorLight = Color(0xEF4444); // Clear red for error states
  static const Color textPrimaryLight =
      Color(0xFF0F172A); // Near-black for primary text
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color onSecondaryLight = Color(0xFFFFFFFF);
  static const Color onSurfaceLight = Color(0xFF0F172A);
  static const Color onErrorLight = Color(0xFFFFFFFF);

  // Dark theme colors - Rich dark tones for low-light reading
  ...
  static const Color surfaceDark =
      Color(0xFF334155); // Warm dark gray for surfaces
  ...
  static const Color shadowLight =
      Color(0x1A000000); // 10% opacity for subtle shadows
  ...
  // Text emphasis levels for reading hierarchy
  static const Color textHighEmphasisLight =
      Color(0xFF0F172A); // 100% for headings
  static const Color textMediumEmphasisLight =
      Color(0x99000000); // 60% for body text
  static const Color textDisabledLight = Color(0x61000000); // 38% for captions

  static const Color textHighEmphasisDark =
      Color(0xFFF8FAFC); // 100% for headings
  static const Color textMediumEmphasisDark =
      Color(0x99FFFFFF); // 60% for body text
  static const Color textDisabledDark = Color(0x61FFFFFF); // 38% for captions

  /// Light theme optimized for daytime reading
  static ThemeData lightTheme = ThemeData(
    ...
    // Contextual App Bars - SliverAppBar for reading optimization
    ...
    // Bottom navigation optimized for content discovery
    ...
    // Floating Action Patterns - Contextual primary actions
    ...
    // Button themes for content interaction
    ...
    // Smart Typography Scaling - Dynamic text sizing for readability
    ...
    // Interactive elements for content engagement
    ...
    // Contextual Bottom Sheets for sharing and actions
  ...
  /// Uses Inter for headings/UI and Inter for body text (replacing unavailable Source Serif Pro)
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      // Display styles - Inter for geometric clarity
      ...
      // Headline styles - Inter with optimized weights for mobile
      ...
      // Title styles - Inter for UI consistency
  ...
  /// JetBrains Mono for code snippets and numerical data
